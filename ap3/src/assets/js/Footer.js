  ...
  return (
    <footer class="footer-section">
			<div class="container relative">
				...
				<div class="sofa-img">
					<img alt =""src= {sofa}  class="img-fluid"/>
				</div>

				<div class="row">
					<div class="col-lg-8">
						<div class="subscription-form">
							<h3 class="d-flex align-items-center"><span class="me-1"><img src={envelope_outline} alt="Image" class="img-fluid"/></span><span>Subscribe to Newsletter</span></h3>
